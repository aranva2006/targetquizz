...
public class AccessControlAspectsQuestion {
	...
	@Around("execution(* venkat.example.quizzz.repository.QuestionRepository.save(..)) && args(question)")
	...
	@Around("execution(* venkat.example.quizzz.repository.QuestionRepository.find(Long)) && args(id)")
	...
	@Around("execution(* venkat.example.quizzz.repository.QuestionRepository.findAll())")
	...
	@Around("execution(* venkat.example.quizzz.repository.QuestionRepository.delete(..)) && args(question)")
