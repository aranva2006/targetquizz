...
public class AccessControlAspectsUser {
	...
	@Around("execution(* venkat.example.quizzz.repository.UserRepository.save(..)) && args(user)")
	...
	@Around("execution(* venkat.example.quizzz.repository.UserRepository.find(Long)) && args(id)")
	...
	@Around("execution(* venkat.example.quizzz.repository.UserRepository.findAll())")
	...
	@Around("execution(* venkat.example.quizzz.repository.UserRepository.delete(..)) && args(user)")
