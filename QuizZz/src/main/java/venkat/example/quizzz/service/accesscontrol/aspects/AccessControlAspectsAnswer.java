...
public class AccessControlAspectsAnswer {
	...
	@Around("execution(* venkat.example.quizzz.repository.AnswerRepository.save(..)) && args(answer)")
	...
	@Around("execution(* venkat.example.quizzz.repository.AnswerRepository.find(Long)) && args(id)")
	...
	@Around("execution(* venkat.example.quizzz.repository.AnswerRepository.findAll())")
	...
	@Around("execution(* venkat.example.quizzz.repository.AnswerRepository.delete(..)) && args(answer)")
